      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 relative flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 z-10">
          ...
          <button
            ...
            className={`hidden md:block p-2 rounded-lg border transition-all hover:scale-105 active:scale-95 ${
              darkMode 
        ...
        {/* Store Name - Perfectly Centered Absolutely */}
        <div 
        ...
        >
          <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] flex items-center justify-center shadow-md shadow-purple-900/30 group-hover:scale-105 transition-transform duration-300">
            <span className="text-white font-extrabold text-lg sm:text-xl font-mono">Z</span>
          </div>
          <div className="flex flex-col items-center sm:items-start">
            <span className="text-2xl sm:text-3xl font-black tracking-tight bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 bg-clip-text text-transparent">
              زودها ZWDHA
            </span>
